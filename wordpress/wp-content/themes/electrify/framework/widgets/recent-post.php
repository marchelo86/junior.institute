...
class Pix_Recent_Post_Widget extends WP_Widget {
	...
	function Pix_Recent_Post_Widget() {
		$widget_options = array('classname' => 'recentpost', 'description' => __('Display Recent Posts','pixel8es'));
		parent::WP_Widget('pix_recent_post',__('Pixel8es:: Recent Post','pixel8es'),$widget_options);
	}
...
<?php
	...
	function form( $instance ) {
		$title     = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Recent Posts', 'pixel8es' );
